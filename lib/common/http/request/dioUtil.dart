...
class DioUtil{
  ...
  static Future post(String url,Map<String, dynamic> data,Function callBack,Function errorCallBack,BuildContext context)  async {
    if(_postDio==null) {
    ...
    //处理错误部分
    if (statusCode !=200) {
      RespObj  rspObj =new RespObj(false, statusCode, response.data.toString(), response.data);
      _handError(errorCallBack, rspObj);
    }
    else{
