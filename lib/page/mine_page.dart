...
import 'package:ath_app/common/listTitleCard.dart';
...
class _MinePageState extends State<MinePage> {
  ...
  List<String> widgets = new List<String>.generate(20, (i) => "Item ${i + 1}");
  @override
...
/*                new Text(_overviewTitle, style: Style.headerTextStyle,),
                ...
                _buildNumPanel(),
                ListTitleCard("观看历史",widgets,90,60),
